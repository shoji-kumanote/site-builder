  ...
  "src/filters/hbsTransform.ts"() {
    ...
    hbsTransform = async (transit, context) => {
      try {
        ...
        const result = compiled(__spreadValues(__spreadProps(__spreadValues({}, context.config.getData(transit.srcFilePath)), {
          __file__: transit.srcFilePath,
          __PATH__: path2.relative(context.config.dist, transit.distFilePath ?? ""),
          __ROOT__: path2.relative(transit.distFilePath ?? "", context.config.dist),
          __TIMESTAMP__: stamp,
...
var getCssWorkFlows = (entryPath, cssOptimize2, cssMinify2, cssFormat2, smarty2) => {
...
// src/util/getHbsWorkFlows.ts
var getHbsWorkFlows = (distPath, hbsTransform2, htmlFormat2) => {
  if (hbsTransform2) {
    if (htmlFormat2) {
      return [
        {
...
var getJsWorkFlows = (entryPath, jsOptimize2, jsMinify2, jsFormat2) => {
