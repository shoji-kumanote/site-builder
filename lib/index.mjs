...
const loadConfigFile = async (filePath) => {
    ...
    return {
        ...
        src: getStringArray(configFileData.src).map((x) => path.resolve(configBaseDir, x)),
        vendor: getStringArray(configFileData.vendor).map((x) => path.resolve(configBaseDir, x)),
